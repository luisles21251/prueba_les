...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //_controller = Get.put(MoviesController(getListMoviesUsecCase: sl(), searchMovieUseCase:sl()));
    return GetBuilder<MoviesController>(
      init: _controller,
      builder: (_) {
        return Scaffold(
          backgroundColor:_.theme.value == true ? Color(0xff5ca0d3): Colors.white,
          body: SafeArea(
            child: Column(
             ...
             init: _controller,
              builder: (_) {
                ...
                Container(
                  ...
                  child:  Text(
                    "Hello, what do you \n want to wach ?",
                    style: _.theme.value == true ?  AppFonts.whiteM19:AppFonts.blackL19
                    ),
                  ),
